...
<body>
    ...
    <div class="container Hidove-main">
        <div class="page-header">
            <h1>Upload pic!</h1>
            <p>Single file is up to 5 MB. Upload up to 10 files at one time.</p>
        </div>
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title">Free picture bed click single or multiple choice</h5>
