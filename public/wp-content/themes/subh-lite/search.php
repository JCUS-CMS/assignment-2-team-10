...
<section id="header-section">
	<div class="main-header-overlay"></div>
			<div class="row">
				...
				<span><?php _e("Search Results for:", "subh-lite"); ?></span> <?php the_search_query(); ?>
				</h1>
				</div>	
				</div>
			</div>
...
<section id="front-blog">
        <div class="container-fluid">
            <div class="row no-gutter">	
			
            <div class="col-lg-8 col-md-8 col-sm-12 text-left">
			<?php  $j=0; $i =0; if (have_posts()) : while (have_posts()) : the_post(); ?>
				<article class="col-lg-12 col-sm-12 featured-article wow fadeInUp" class="<?php echo 'pexcerpt'.$i++?> post excerpt <?php echo (++$j % 2 == 0) ? 'last' : ''; ?>">
					<div class="col-lg-4 col-sm-4 padding-zero featured-img">
